  ...
  <div class="app-container">
    <el-row :gutter="20">
      <el-col :span="4">
        ...
        <el-tree ref="tree" :data="categoryData" :props="defaultProps" :expand-on-click-node="false" default-expand-all @node-click="handleNodeClick" :filter-node-method="filterNode"></el-tree>
      </el-col>
      <el-col :span="20">
        <!--start========头部折叠面板===========start-->
